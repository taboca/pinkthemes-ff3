...
.progress-background {
   fill: rgb(180,210,240);
   stop-opacity: 1;
}

.downloadbar-color {
   stop-color: rgb(180,210,240);
   stop-opacity: 1;
}
...
.bigshadeselected-from-color {
   stop-color: rgb(144,168,192);
   stop-opacity: 1;
}

.bigshadeselected-to-color {
   stop-color: rgb(210,228,246);
   stop-opacity: 1;
}
